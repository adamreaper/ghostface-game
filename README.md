...
- `assets/modern-fit/ghostface_modern_fit_attack_clean_v13_96x128.png` — runtime player attack atlas using the same full-body modern cells while the engine draws the slash arc separately for better mobile readability; versioned filename forces mobile browsers past cached phantom sprites
