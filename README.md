...
- `assets/modern-fit/ghostface_modern_fit_attack_v14_96x128.png` — runtime player attack atlas with phantom-cleaned full-body modern cells plus distinct lunge/knife/slash frames for readable mobile attack animation
